# Fibroids During Pregnancy - Reveal.js Presentation

Patient education presentation on fibroids during pregnancy, monitoring, and delivery planning.

## Files

- `index.html` - Main Reveal.js presentation
- `theme.css` - Custom styling and theme
- `fibroids.html` - Original version (for reference)
- `fibroids-in-pregnancy.png` - Infographic
